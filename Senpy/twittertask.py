            ...
            for line in fin:
                ...
                if analisisInsomnia:
                    ...
                    if tweet["Longitud"]!="ERROR AL GEOLOCALIZAR":
                        ...
                        tweetDic={'_id':tweet["id_str"],'created_at':tweet["created_at"],'id_str':tweet["id_str"],'user':tweet["user"]["id_str"],'text':tweet["text"],'long':tweet["Longitud"],'lat':tweet["Latitud"],'sentiment':analisisSentiment,'emotion':analisisEmotion,'is_insomniac':analisisInsomnia[0],'theme':analisisInsomnia[1]}
...
class Elasticsearch(CopyToIndex):
    ...
    """
    #: date task parameter (default = today)
    id = luigi.Parameter(default="2018_04_24_00_00_00_00")
    ...
    def requires(self):
        ...
        * :py:class:`~.SenpyTask`
        ...
        return AnalizeTask(self.id,self.query,self.num,self.user_twitter,"2018_04_24_00_00_00_00")
